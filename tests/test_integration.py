...
class MockCmdrDataServer:
    ...
    def handle_request(
        ...
        return {
            ...
            "event_id": f"evt_{len(self.received_events)}",
        }
...
class TestIntegrationBasic:
    ...
    def test_basic_tracking_flow(self, mock_post, mock_server, mock_openai_client):
        ...
        # Create wrapped client - instantiate the mock class
        client = track_ai(
    ...
    def test_multiple_providers(self, mock_post, mock_server):
        ...
        for provider_name, (module, model) in providers.items():
            ...
            # Wrap and track
            client = track_ai(MockClient(), cmdrdata_api_key="test-api-key")
    ...
    def test_error_tracking(self, mock_post, mock_server):
        ...
        client = track_ai(FailingClient(), cmdrdata_api_key="test-api-key")
...
class TestIntegrationRealProviders:
    ...
    def test_openai_response_format(self, mock_post):
        ...
        client = track_ai(RealisticOpenAI(), cmdrdata_api_key="test-api-key")
    ...
    def test_anthropic_response_format(self, mock_post):
        ...
        class RealisticAnthropic:
            class Messages:
                def create(self, **kwargs):
                    response = Mock(
                        spec=["id", "type", "role", "content", "model", "usage"]
                    )
                    response.id = "msg_123"
        ...
        client = track_ai(RealisticAnthropic(), cmdrdata_api_key="test-api-key")
...
class TestIntegrationPerformance:
    ...
    def test_high_volume_tracking(self, mock_post):
        ...
        client = track_ai(FastClient(), cmdrdata_api_key="test-api-key")
    ...
    def test_concurrent_tracking(self, mock_post):
        ...
        class ThreadSafeClient:
            def generate(self, thread_id, call_id, **kwargs):
                return {
        ...
        client = track_ai(ThreadSafeClient(), cmdrdata_api_key="test-api-key")
...
class TestIntegrationEdgeCases:
    ...
    def test_missing_usage_data(self, mock_post):
        ...
        client = track_ai(NoUsageClient(), cmdrdata_api_key="test-api-key")
    ...
    def test_network_timeout(self, mock_post):
        ...
        client = track_ai(TimeoutTestClient(), cmdrdata_api_key="test-api-key")
